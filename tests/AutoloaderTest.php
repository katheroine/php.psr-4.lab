...
{
    protected const string AUTOLOADER_FULLY_QUALIFIED_CLASS_NAME = 'PHPLab\\StandardPSR4\\Autoloader';
    ...
    #[Test]
    public function unregisteredNamespaceDoesNotAllowClassLoading()
    {
        $this->assertClassDoesNotExist('\Vendor\Package\Dummy\ComponentExistent');
    }
