...
class Autoloader
{
    ...
    private function findRegisteredNamespacePrefixesWithPaths(string $processedNamespacedClassName): array
    {
        ...
        foreach ($this->registeredNamespacePrefixesWithPaths as $namespacePrefix => $paths) {
            if (! $this->hasNamespacePrefixMatch($processedNamespacedClassName, $namespacePrefix)) {
                continue;
            }
    ...
    private function hasNamespacePrefixMatch(string $namespacedClassName, string $namespacePrefix): bool
    {
    ...
    private function unprefixNamespacedClassName(string $namespacedClassName, string $namespacePrefix): string
    {
